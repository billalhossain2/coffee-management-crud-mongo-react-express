      ...
      <div className="flex lg:flex-row flex-col justify-between max-w-[80%] mx-auto lg:gap-80 gap-16">
        ...
        <div>
          ...
          <form className="lg:max-w-[300px] md:max-w-[300px] w-[100%]">
            <input
              className="w-[100%] my-3 p-3 border-0 outline-none rounded-lg hover:outline-1 hover:outline-dotted hover:outline-black"
              type="text"
              name="name"
              placeholder="Name"
            />
            ...
            <br />
            <textarea
              className="outline-none p-3 rounded-lg w-[100%]  hover:outline-1 hover:outline-dotted hover:outline-black"
              name="comment"
              id="comment"
              cols="60"
              rows="5"
            ...
            <br />
            <input
              className="my-3 text-2xl border-[1px] border-solid border-black rounded-full py-2 px-5 cursor-pointer"
              type="submit"
              value="Send Message"
            />
          </form>
